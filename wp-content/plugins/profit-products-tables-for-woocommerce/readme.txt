...
Tags: product table,product filter,products table,products tables,woocommerce product table
...
WOOT - WooCommerce Products Table: is the Woo Product Table plugin displaying shop products in table format

== Description ==

**WooCommerce Products Table** by PluginUs.NET is WordPress plugin for WooCommerce products, created for displaying woo shop products in the table format. Woo Products tables makes focus for your buyers on the things they want to get, nothing superfluous, just what the client wants, and full attention to what is offered! Ideal way to higher sells on your woocommerce store!

Latest PHP 7.4.x - FULL COMPATIBILITY! Compatibility: from v.3.6 to the latest woocommerce version.
...
&#9989;&nbsp;[Compatible with WOOBE](https://bulk-editor.com/)
