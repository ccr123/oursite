...
final class WOOT_WooCommerce {
        ...
        $profile = [
            ...
            'post_author' => [
                ...
                'get_filter_draw_data' => function($table_id) {
                    ...
                    $title = esc_html__('Author', 'profit-products-tables-for-woocommerce');
                    if (woot()->columns->get_by_field_key($table_id, 'post_author')) {
                        $title = WOOT_Vocabulary::get(woot()->columns->get_by_field_key($table_id, 'post_author')['title']);
                    }
                ...
                case 'price':
                    ...
                    if ($product->get_type() === 'variable') {
                        ...
                        if ($sale_price = $product->get_sale_price()) {
                            ...
                            $value = WOOT_WooCommerce::wc_price($product->$func_name());
                        }
                    }
     ...
     * @return array gields
     */
    public static function get_select_orderby_options($fields_keys = '', $table_id) {
