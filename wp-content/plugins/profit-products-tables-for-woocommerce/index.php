...
/*
  ...
  Version: 1.0.2
  Requires PHP: 7.0
  Tags: tables, products, filter, woocommerce, products tables
...
class WOOT {
    ...
    /**
     * Main query function, as by ajas so and direct call
     *
     * @since 1.0.0
    ...
    public function get_table_data($return = false, $request = []) {
        ...
        if (isset($request['shortcode_args_set'])) {
            ...
            if (isset($shortcode_args_set['mode']) AND $shortcode_args_set['mode'] === 'to_json') {
