 ...
 */
class Corponess_Dropdown_Taxonomies_Control extends WP_Customize_Control {
    ...
    <label>
      ...
      <?php endif; ?>
       <select <?php $this->link(); ?>>
			<?php
			printf( '<option value="%s" %s>%s</option>', '', selected( $this->value(), '', false ),  esc_html__( '--None--', 'corponess') );
			?>
...
class Corponess_Note_Control extends WP_Customize_Control {
...
class Corponess_Switch_Control extends WP_Customize_Control{
	public $type = 'switch';
...
class Corponess_Dropdown_Chooser extends WP_Customize_Control{
	...
	public function render_content(){
		...
		?>
            <label>
                ...
                <select class="corponess-chosen-select" <?php $this->link(); ?>>
                    <?php
 ...
 */
class Corponess_Custom_Radio_Image_Control extends WP_Customize_Control {
...
class Corponess_Customize_Sortable_Control extends WP_Customize_Control {
  ...
  public function render_content() {
    ...
    <ul class="corponess-sortable-list">
      ...
      ?>
        ...
        <li>
            <input class="corponess-sortable-input sortable-hideme" name="<?php echo esc_attr( $value ); ?> " type="hidden"  value="<?php echo esc_attr( $value ); ?>" />
            <span class ="menu-item-handle sortable-span"> <?php echo esc_attr( $choices[$value] ); ?> </span>
          <i class="dashicons dashicons-menu corponess-drag-handle"></i>
        </li>
        ...
        <li class="sortable-hideme">
          <input class="corponess-sortable-value" <?php $this->link(); ?> value="<?php echo esc_attr( $this->value() ); ?>" />
        </li>
...
class Corponess_Icon_Picker extends WP_Customize_Control{
	...
	public function render_content(){
		...
		?>
            <label>
                ...
                <input id="corponess-<?php echo esc_attr( $id ); ?>" placeholder="<?php esc_attr_e( 'Click here to select icon', 'corponess' ); ?>" class="corponess-icon-picker input" <?php $this->link(); ?> value="<?php echo esc_attr( $this->value() ); ?>" />
            </label>
		<?php
	}
}
...
class Corponess_Customize_Horizontal_Line extends WP_Customize_Control {
	public $type = 'hr';
 ...
 * @see WP_Customize_Control
 */
class Corponess_Dropdown_Category_Control extends WP_Customize_Control {
 ...
 * @since  1.0.0
 */
class Corponess_Multi_Input_Custom_Control extends WP_Customize_Control {
	/**
	 * Control type
	 *
	 * @var string
