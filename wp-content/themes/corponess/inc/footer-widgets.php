...
class Corponess_Footer_Widgets{
	 ...
	 * @var int
	 */
	protected $theme_prefix = 'corponess';
	...
	function footer_widgets_init() {
		...
		for ( $i = 1; $i <= $this->max_widgets; $i++ ) {
			register_sidebar( array(
				'name'          => sprintf( __( 'Footer Widget %d', 'corponess' ), $i ),
...
// Initialize.
$corponess_footer_widgets = new Corponess_Footer_Widgets();
